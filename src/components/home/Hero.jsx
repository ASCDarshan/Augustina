      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 sm:pt-24 sm:pb-20">
        ...
        >
          ...
          <div>
            ...
            >
              15 years of sustainable & innovative technologies converting biomass waste into valuable renewable energy solutions.
            </motion.p>
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Converting biomass waste into value</p>
                  </div>
                </div>
              </motion.div>
