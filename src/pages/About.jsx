      ...
      <section className="relative bg-gradient-to-b from-primary-50 to-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Engineering, designing, fabricating, and supplying renewable technologies to convert biomass waste into combustible fuel and gases.
            </motion.p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
              ...
              <ul className="space-y-4 text-gray-600">
                <li className="flex items-start">
                  ...
                  <span>Develop more innovative and efficient solutions in biomass waste sector</span>
                </li>
                <li className="flex items-start">
                  <span className="w-1.5 h-1.5 bg-primary-500 rounded-full mt-2 mr-2 flex-shrink-0" />
                  <span>Provide assistance to projects that generate huge biomass wastes</span>
                </li>
                <li className="flex items-start">
                  <span className="w-1.5 h-1.5 bg-primary-500 rounded-full mt-2 mr-2 flex-shrink-0" />
            ...
            >
              ...
              <p className="text-gray-600">
                To process and convert 20 million tonnes of biomass waste into reusable fuel.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              With strong teamwork and in-depth research, we create new concepts and means to treat biomass waste
            </p>
          </motion.div>
